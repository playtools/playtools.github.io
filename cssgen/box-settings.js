...
function BorderRadiusSetting(elementName, getUpdateBoxDelegate, afterUpdateDelegate) {
    ...
    var me = this;
    this.Slider = setupSlider(elementName, 0, 50, function() {
        me.Update();
    });
}
...
function BoxShadowSetting(elementName, getUpdateBoxDelegate, afterUpdateDelegate) {
    ...
    var me = this;
    this.OffsetSlider = setupSlider(elementName + "Offset", -50, 50, function() {
        me.Update();
    });
    this.BlurSlider = setupSlider(elementName + "Blur", 0, 50, function() {
        me.Update();
    });
    this.ColorPalette = setupColorPalette(elementName + "Color", function() {
        me.Update();
    });
}
...
function TransformSetting(elementName, getUpdateBoxDelegate, afterUpdateDelegate) {
    ...
    var me = this;
    this.RotateSlider = setupSlider(elementName + "Rotate", -180, 180, function() {
        me.Update();
    });
    this.ScaleSlider = setupSlider(elementName + "Scale", 0, 5, function() {
        me.Update();
    });
    this.SkewSlider = setupSlider(elementName + "Skew", -80, 80, function() {
        me.Update();
    });
    this.SkewYSlider = setupSlider(elementName + "SkewY", -80, 80, function() {
        me.Update();
    });
}
...
function BorderSetting(elementName, getUpdateBoxDelegate, afterUpdateDelegate) {
    ...
    var me = this;
    this.WidthSlider = setupSlider(elementName + "Width", 0, 50, function() {
        me.Update();
    });
    this.ColorPalette = setupColorPalette(elementName + "Color", function() {
        me.Update();
...
function OpacitySetting(elementName, getUpdateBoxDelegate, afterUpdateDelegate) {
    ...
    var me = this;
    this.Slider = setupSlider(elementName, 0, 1, function() {
        me.Update();
    });
}
...
function TextSetting(elementName, getUpdateBoxDelegate, afterUpdateDelegate) {
    ...
    var me = this;
    this.SizeSlider = setupSlider(elementName + "Size", 4, 50, function() {
        me.Update();
    });
    this.ColorPalette = setupColorPalette(elementName + "Color", function() {
        me.Update();
    });
    this.FontComboBox = setupComboBox(elementName + "Font", function() {
        me.Update();
    });
    dojo.byId(elementName + "Alignment").onchange = function() {
        me.Update();
    };
    setupCheckBox(elementName + "Bold", function() {
        me.Update();
    });
    setupCheckBox(elementName + "Italic", function() {
        me.Update();
    });
}
...
function ContentSetting(elementName, getUpdateBoxDelegate, afterUpdateDelegate) {
    ...
    var me = this;
    setupText(elementName + "Text", function() {
        me.Update();
    });
}
...
function SingleNumberSetting(styleName, minValue, maxValue, unitSuffix, elementName, getUpdateBoxDelegate, afterUpdateDelegate) {
    ...
    var me = this;
    this.Slider = setupSlider(elementName, minValue, maxValue, function() {
        me.Update();
    });
}
...
function GradientBackgroundSetting(elementName, getUpdateBoxDelegate, afterUpdateDelegate) {
    ...
    var me = this;
    this.FromColorPalette = setupColorPalette(elementName + "FromColor", function() {
        me.Update();
    }, function() {
        me.ForceDirection();
    });
    this.FromPositionSlider = setupSlider(elementName + "FromPosition", 0, 100, function() {
        me.Update();
    });
    this.ToColorPalette = setupColorPalette(elementName + "ToColor", function() {
        me.Update();
    }, function() {
        me.ForceDirection();
    });
    this.ToPositionSlider = setupSlider(elementName + "ToPosition", 0, 100, function() {
        me.Update();
    });
    dojo.byId(elementName + "Direction").onchange = function() {
        me.Update();
    };
}
...
function OutlineSetting(elementName, getUpdateBoxDelegate, afterUpdateDelegate) {
    ...
    this.OffsetSlider = setupSlider(elementName + "Offset", 0, 50, function() {
        me.Update();
    });
    this.ColorPalette = setupColorPalette(elementName + "Color", function() {
        me.Update();
...
function ColumnSetting(elementName, getUpdateBoxDelegate, afterUpdateDelegate) {
    ...
    var me = this;
    this.CountSlider = setupSlider(elementName + "Count", 1, 10, function() {
        me.Update();
    });
    this.GapSlider = setupSlider(elementName + "Gap", 0, 50, function() {
        me.Update();
    });
    this.RuleWidthSlider = setupSlider(elementName + "RuleWidth", 0, 50, function() {
        me.Update();
    });
    this.RuleColorPalette = setupColorPalette(elementName + "RuleColor", function() {
        me.Update();
    });
}
